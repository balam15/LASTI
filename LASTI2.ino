...
const char* ssid = "04F2G_577470";   // Wifi SSID
const char* password = "wlana88b8f";  // Wifi Password
const char* username = "nadiraF"; // my AskSensors username
const char* pubTopic = "publish/nadiraF/RaMFQlyNrUGCePJuNGg8AQoeAa4r1EGj"; // publish/username/apiKeyIn
